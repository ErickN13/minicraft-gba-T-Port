...
static void death_draw(void) {
    ...
    screen_write("VOCE MORREU! OUN!", 4, death_x + 1, death_y + 1);

    screen_write("JOGATINA:", 4, death_x + 1, death_y + 2);
    screen_write_time(gametime, 8, death_x + 6, death_y + 2);

    screen_write("PONTOS:", 4, death_x + 1, death_y + 3);
    SCREEN_WRITE_NUMBER(score, 10, 10, false, 8, death_x + 7, death_y + 3);

    screen_write("PRESSIONE A PARA RESPAWN", 6, death_x + 1, death_y + 5);
}
